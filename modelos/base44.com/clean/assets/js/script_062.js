    ...
    var e = {
        "w1+p": function(t, e, r) {
          ...
          e.whiteList = {
            ...
            return r = T(r)
          }, e.escapeHtml = l, e.escapeQuote = w, e.unescapeQuote = y, e.escapeHtmlEntities = x, e.escapeDangerHtml5Entities = k, e.clearNonPrintableCharacter = A, e.friendlyAttrValue = S, e.escapeAttrValue = T, e.onIgnoreTagStripAll = function() {
            return ""
          ...
          }, e.attributeWrapSign = '"', e.cssFilter = s, e.getDefaultCSSWhiteList = i
        },
        "z3+u": function(t, e, r) {
          var n = r("w1+p"),
            i = r("YJ6l"),
          ...
          e.parseTag = function(t, e, r) {
            ...
            t: for (c = 0; c < u; c++) {
              ...
              if (!1 === s) {
                ...
                if (">" === p || c === u - 1) {
                  n += r(t.slice(a, s)), f = i(d = t.slice(s, c + 1)), n += e(s, n.length, f, d, o(d)), a = c + 1, s = !1;
                  continue
                }
                if ('"' === p || "'" === p)
                  for (var g = 1, m = t.charAt(c - g);
                    "" === m.trim() || "=" === m;) {
                    if ("=" === m) {
                      l = p;
                      continue t
              ...
              if (!1 !== f || "=" !== h)
                if (!1 === f || g !== i)
                  if (/\s|\n|\t/.test(h)) {
                    if (t = t.replace(/\s|\n|\t/g, " "), !1 === f) {
                      if (-1 === (m = s(t, g))) {
                        p(n.trim(t.slice(r, g))), f = !1, r = g + 1;
                        continue
                      }
                      g = m - 1;
                      continue
                    ...
                    if (-1 === (m = c(t, g - 1))) {
                      p(f, u(n.trim(t.slice(r, g)))), f = !1, r = g + 1;
                      continue
                    }
                  } else;
              else {
                if (-1 === (m = t.indexOf(h, g + 1))) break;
                p(f, n.trim(t.slice(i + 1, m))), f = !1, r = (g = m) + 1
              } else f = t.slice(r, g), r = g + 1, i = '"' === t.charAt(r) || "'" === t.charAt(r) ? r : l(t, g + 1)
            }
            return r < t.length && (!1 === f ? p(t.slice(r)) : p(f, u(n.trim(t.slice(r))))), n.trim(o.join(" "))
          }
        },
        JUwi: function(t) {
          t.exports = {
        ...
        g9b2: function(t, e, r) {
          ...
          u.prototype.process = function(t) {
            ...
            var b = !1;
            r.stripIgnoreTagBody && (b = i.StripTagBody(r.stripIgnoreTagBody, u), u = b.onIgnoreTag);
            var v = a(t, function(t, e, r, i, a) {
              var b = {
                  sourcePosition: t,
                  position: e,
                  isClosing: a,
              ...
              if (b.isWhite) {
                ...
                var w = function(t) {
                  ...
                  y = n[r],
                  x = s(w.html, function(t, e) {
                    var n = -1 !== l.indexOf(y, t),
                      i = f(r, t, e, n);
                    return c(i) ? n ? (e = p(r, t, e, h)) ? t + "=" + m + e + m : t : c(i = d(r, t, e, n)) ? void 0 : i : i
                  });
                return i = "<" + r, x && (i += " " + x), w.closing && (i += " /"), i += ">"
              }
              return c(v = u(r, i, b)) ? g(i) : v
            }, g);
    ...
    return function() {
      ...
      function o(t) {
        ...
        if ("string" == typeof t || "number" == typeof t) n += t;
          ...
          if (Array.isArray(t))
            for (e = 0; e < t.length; e++) t[e] && (r = o(t[e])) && (n && (n += " "), n += r);
          else
      ...
      var a = function() {
        ...
        l = n.n(s);
      const c = ["data", "aria"],
        u = ["style", "class", "dir", "wix-comp", "role", "tabindex", "focus", "start"],
        f = ["href", "dataquery", "id", "rel", "target"],
        d = ["color", "background-color", "font-size", "font-family", "font-style", "text-decoration", "writing-mode", "text-orientation", "line-height", "text-shadow", "direction", "position", "z-index", "top", "left", "overflow", "overflow-x", "overflow-y"];
      const p = function() {
          const t = {
            ...s.whiteList,
            strike: [],
          ...
          return t.a && t.a.push(...f), Object.keys(t).forEach(e => {
            t[e] || (t[e] = []), t[e].push(...u)
          }), t
        }(),
        g = d.reduce((t, e) => (t[e] = !0, t), {});
      ...
      function m(t) {
        return l()(t, {
          ...
          css: {
            whiteList: {
              ...(0, s.getDefaultCSSWhiteList)(),
              ...g
            }
          },
          safeAttrValue: function(t, e, r, n) {
            const i = function(t, e, r, n) {
              return "a" === t && "href" === e && r.startsWith("wix:document") ? r : (0, s.safeAttrValue)(t, e, r, n)
            }(t, e, r, n);
            return i || ""
          },
          onIgnoreTagAttr(t, e, r) {
            return c.some(t => e.startsWith(t)) ? `${e}="${r}"` : ""
          },
          onIgnoreTag() {
            return ""
          }
      ...
      var b = t => {
        ...
        return c && (S.dangerouslySetInnerHTML = {
          __html: m(l)
        }), r.useEffect(() => {
          ! function(t) {
            let {
          ...
          function(t) {
            ...
            Object.entries(r).forEach(t => {
              ...
              const i = function() {
                ...
                e.current.dispatchEvent(new CustomEvent(r + "__" + n, {
                  detail: {
                    args: i
                  },
                  bubbles: !0
              ...
              v(e) && (e.current[r] = i.bind(e.current))
            })
          }({
            compRef: k,
            directMethods: b
          ...
          p && d.filter(t => !A.current[t]).forEach(t => {
            var e;
            null == (e = k.current) || e.addEventListener(t, e => {
              p({
                type: t,
                detail: e.detail
              })
          ...
          u && customElements.whenDefined(i).then(() => {
            var t;
            return null == (t = k.current) || null == t.accessTokenListener ? void 0 : t.accessTokenListener(u)
          }).catch(() => {})
        }, [u, i]), f ? r.createElement("div", e()({
          id: n
        }, (t => Object.entries(t).reduce((t, [e, r]) => (e.includes("data-") && (t[e] = r), t), {}))(t), {
          className: a(h, g),
          onMouseEnter: y,
          onMouseLeave: x,
          "data-testid": "custom-element"
        }), r.createElement(i, S)) : r.createElement("div", {
          id: n,
      ...
      function v(t) {
        return "object" == typeof(null == t ? void 0 : t.current) && null !== (null == t ? void 0 : t.current)
      }
      const w = t => t.replace(/([A-Z])/g, t => `-${t.toLowerCase()}`);
      var y;
      const x = {
        CustomElementComponent_CustomElement: {
          component: t => r.createElement(b, e()({}, t, {
            isEnabled: !0
          })),
          controller: (y = t => {
            let {
            ...
            return {
              ...
              fixHeight: t => {
                ...
                e > 0 && n({
                  "--custom-element-height": e + "px !important",
              ...
              updateMinHeight: t => {
                ...
                n({
                  "--custom-element-min-height": e + "px !important"
                })
              }
            }
          }, {
            useComponentProps: (t, e, r) => {
              const n = (t => ({
                ...t,
                updateStyles: e => {
                  const r = Object.entries(e).reduce((t, [e, r]) => {
                    return {
                      ...t,
                      [(n = e, n.startsWith("--") ? e : w(e))]: void 0 === r ? null : r
                    };
                    var n
                  }, {});
                  t.updateStyles(r)
