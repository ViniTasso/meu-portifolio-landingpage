  ...
  ["3033"], {
    17709(t) {
      ! function(e) {
        ...
        function s() {
          this.reads = [], this.writes = [], this.raf = n.bind(e), i("initialized", this)
        }

        function r(t) {
          t.scheduled || (t.scheduled = !0, t.raf(a.bind(null, t)), i("flush scheduled"))
        }
        ...
        function a(t) {
          ...
          var e, n = t.writes,
            s = t.reads;
          try {
            i("flushing reads", s.length), t.runTasks(s), i("flushing writes", n.length), t.runTasks(n)
          } catch (t) {
            e = t
          }
        ...
        s.prototype = {
          ...
          extend: function(t) {
            if (i("extend", t), "object" != typeof t) throw Error("expected object");
