! function() {
  ...
  var f = function(t) {
    ...
    var r, o, f, l, a, p = (r = s, o = i(), function() {
      var t, e = c(r);
      if (o) {
    ...
    return f = s, a = [{
      ...
      key: "dispatch",
      value: function() {
        var t = document.cookie.split("_wixCIDX=")[1].split(";")[0];
        this.dispatchEvent(new CustomEvent("clientIdEvent", {
          detail: {
            data: t
          }
        }))
      ...
      value: function(t, e, n) {
        "ready" === t && this.dispatch()
      }
    }]) && e(f.prototype, l), a && e(f, a), Object.defineProperty(f, "prototype", {
      writable: !1
    }), s
  }(r(HTMLElement));
  customElements.define("client-id-custom-element", f)
}();
