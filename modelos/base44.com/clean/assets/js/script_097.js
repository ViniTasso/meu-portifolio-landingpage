...
(self.webpackJsonp__wix_thunderbolt_app = self.webpackJsonp__wix_thunderbolt_app || []).push([
  ["8051"], {
    16956(e, t, i) {
      ...
      function r(e, t, i) {
        return void 0 === e && (e = [0, 0]), void 0 === t && (t = [0, 0]), void 0 === i && (i = 0), (360 + i + 180 * Math.atan2(t[1] - e[1], t[0] - e[0]) / Math.PI) % 360
      }
      i.d(t, {
        Io: () => o,
        Rb: () => r,
    ...
    85492(e, t, i) {
      ...
      function s(e, t) {
        let i;
        return e ? /^-?\d+px$/.test(e) ? parseInt(e) : /^-?\d+[lsd]?vh$/.test(e) ? parseInt(e) * t.viewportHeight / 100 : /^-?\d+[lsd]?vw$/.test(e) ? parseInt(e) * t.viewportWidth / 100 : /^calc\s*\(\s*-?\d+((px)|([lsd]?vh)|([lsd]?vw))\s*\+\s*-?\d+((px)|([lsd]?vh)|([lsd]?vw))\s*\)\s*$/.test(e) ? s((i = e.match(/^calc\s*\(\s*(-?\d+((px)|([lsd]?vh)|([lsd]?vw)))\s*\+\s*(-?\d+((px)|([lsd]?vh)|([lsd]?vw)))\s*\)\s*$/))[1], t) + s(i[6], t) : parseInt(e) || 0 : 0
      }
      ...
      function r(e, t, i) {
        let n, o, {
          ...
          f = h - c;
        return "entry" === s ? (n = c - t, o = Math.min(t, f)) : "entry-crossing" === s ? (n = c - t, o = f) : "contain" === s ? (n = Math.min(h - t, c), o = Math.abs(t - f)) : "exit" === s ? (n = Math.max(c, h - t), o = Math.min(t, f)) : "exit-crossing" === s ? (n = c, o = f) : "cover" === s && (n = c - t, o = f + t), n + r / 100 * o | 0
      }
        ...
        return e.forEach((t, c) => {
          ...
          if (h) {
            if ("end" in h && e[c - 1]?.element) {
              let e = ((o ? t.element.offsetWidth : t.element.offsetHeight) || 0) + h.end - n,
                c = s + e - t.offset,
                f = c < r.start,
                l = 0;
              (f || !f && c <= i) && (l = t.offset, r.end += l), f && (r.start += l)
            }
            if ("start" in h) {
              let i = s - h.start,
                n = i < r.start,
                ...
                l = 0,
                d = e[c - 1]?.element;
              d && ((n || f) && (l = ((o ? d.offsetWidth : d.offsetHeight) || 0) - (t.offset + ((o ? t.element.offsetWidth : t.element.offsetHeight) || 0)), s += l, r.end += l), n && (r.start += l))
            }
          }
        }), r
      }
      ...
      function h(e, t, i, n, o) {
        ...
        for (; a;) {
          ...
          let e = window.getComputedStyle(a),
            i = "sticky" === e.position,
            o = i ? function(e, t) {
              let i, n = parseInt(t ? e.left : e.top),
          ...
          if (o && "end" in o || (d += s), f.push({
              element: a,
              offset: s,
              sticky: o
            }), a = a.offsetParent, u = a, "fixed" === e.position && (!u || u === window.document.body || u === t)) break;
          if (a === t) {
            f.push({
              element: a,
              offset: 0
      ...
      class a {
        constructor(e = {}) {
          this.config = n(e, d), this.progress = {
            p: 0,
            prevP: 0,
            vp: 0
        ...
        lerp() {
          this.currentProgress.p = function(e, t, i, n) {
            ...
            if (n) {
              let i = o - e;
              if (Math.abs(i) < n && (o = e + n * Math.sign(i)), Math.abs(t - o) < n) return t
            }
            return o
        ...
        setupEffect() {
          this.removeEffect(), this.effect = function(e) {
            let t, i, s, r, c, d = n(e, f),
              a = d.root,
              u = d.horizontal,
              v = new WeakMap,
              p = l(a, u),
            ...
            if (d.scenes = Object.values(e.scenes.reduce((e, t, i) => {
                let n = t.groupId ? `group-${t.groupId}` : String(i);
                return e[n] ? e[n].push(t) : e[n] = [t], e
              }, {})).flatMap(e => (e.every(e => e.viewSource && ("string" == typeof e.duration || e.start?.name)) ? (e = h(e, a, p, u, w), (d.observeSourcesResize || d.observeContentResize) && g.push(e)) : e.forEach(e => {
                null == e.end && (e.end = e.start + e.duration), null == e.duration && (e.duration = e.end - e.start)
              }), e)), d.scenes.forEach((e, t) => {
                e.index = t
              }), g.length) {
              let e = new Map;
              window.ResizeObserver && (s = new window.ResizeObserver(function(t) {
                t.forEach(t => {
                ...
                s.observe(t[0].viewSource, {
                  box: "border-box"
                }), e.set(t[0].viewSource, t)
              }), d.observeContentResize && d.contentRoot && new window.ResizeObserver(o(() => {
                let t = g.map(e => {
                  let t = h(e, a, p, u, w);
                ...
                g.length = 0, g.push(...t), g.forEach(t => {
                  e.set(t[0].viewSource, t)
                })
              }, 100)).observe(d.contentRoot, {
                box: "border-box"
              })), d.observeViewportResize && (r = o(function() {
                p = l(a, u);
                let t = g.map(e => {
                  let t = h(e, a, p, u, w);
                  return t.forEach((e, i) => {
              ...
              }, 100), a === window ? window.addEventListener("resize", r) : window.ResizeObserver && (c = new window.ResizeObserver(r)).observe(a, {
                box: "border-box"
              }))
            }
            return d.observeViewportEntry && window.IntersectionObserver && (i = new window.IntersectionObserver(function(e) {
              e.forEach(e => {
              ...
              if (e.viewSource) {
                ...
                t || (t = [], v.set(e.viewSource, t), i.observe(e.viewSource)), t.push(e)
              }
            })), {
              tick: function({
                p: e,
              ...
              destroy: function() {
                d.scenes.forEach(e => e.destroy?.()), i && (i.disconnect(), i = null), s && (s.disconnect(), s = null), r && (c ? (c.disconnect(), c = null) : window.removeEventListener("resize", r))
              }
            }
          }(this.config)
        }
    ...
    59630(e, t, i) {
      ...
      class a {
        constructor(e = {}) {
          ...
          this.config = {
            ...e
          }, this.effect = null, this._nextTick = null, this._nextTransitionTick = null, this._startTime = 0, t = this.config.transitionDuration ? this.config.noThrottle ? () => this.transition() : s(() => this.transition()) : this.config.noThrottle ? () => (this.tick(), null) : s(() => {
            this.tick()
          ...
          if (this._pointerLeave = () => {
            ...
            const e = (n = "boolean" == typeof n ? n : function() {
              ...
              let i = new PointerEvent("pointerdown", {
                clientX: 10
              });
              return document.body.dispatchEvent(i), t
            }()) ? window.devicePixelRatio : 1;
            void 0 === d.fixRequired && function(e) {
              new Promise(e => {
                let t, i = window.scrollY,
                  n = !1;
                ...
                function o() {
                  ...
                  let e = new PointerEvent("pointerdown", {
                    clientY: 500
                  });
                  document.body.dispatchEvent(e)
                }
                o(), window.addEventListener("scroll", function t() {
                  window.scrollY !== i && (window.removeEventListener("scroll", t), o(), e(n))
        ...
        setupEffect() {
          var e;
          let t, i, n, s, l, d, a;
          this.removeEffect(), this.effect = (e = this.config, l = !1, d = {
            x: e.rect.width / 2,
            y: e.rect.height / 2,
            vx: 0,
            vy: 0
            ...
            var o, s;
            if (t.target && t.centeredToTarget && (o = function(e) {
                let t = e,
                  i = 0,
                  n = 0;
                if (t.offsetParent)
                  do i += t.offsetLeft, n += t.offsetTop, t = t.offsetParent; while (t);
                return {
                  left: i,
                  top: n,
                  width: e.offsetWidth,
            ...
            } else n = f.bind(null, e), window.addEventListener("resize", n)
          }), t = function(t) {
            for (let i of e.scenes)
              if (!i.disabled) {
                ...
                e.allowActiveEvent && (t.active = n <= 1 && s <= 1 && n >= 0 && s >= 0), i.effect(i, {
                  x: r,
                  y: c
                }, h, t.active)
              } Object.assign(d, t)
            ...
            return r || (n = e => {
                ...
                c.clear(), document.removeEventListener("touchstart", n), document.removeEventListener("touchend", o)
              }), r += 1, e.addEventListener("scroll", h),
              function() {
            ...
            tick: t,
            destroy: function() {
              e.scenes.forEach(e => e.destroy?.()), s?.(), i ? (i.disconnect(), i = null) : (window.removeEventListener("resize", n), n = null), t = null, d = null
            }
          })
        }
        removeEffect() {
