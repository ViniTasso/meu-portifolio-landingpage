! function() {
      ...
      value: function(t, e, n) {
        ...
        if ("elementid" === t) {
          var o = null,
            i = !1;
          setTimeout((function() {
              i || (clearTimeout(o), i = !0, r.dispatchEvent(new CustomEvent("dimensions", {
                detail: null
              })))
            }), 1e3),
            function t() {
              ...
              if (e) {
                var u = e.clientWidth,
                  c = e.clientHeight;
                i = !0, r.dispatchEvent(new CustomEvent("dimensions", {
                  detail: {
                    width: u,
                    height: c
                  }
  ...
  customElements.define("get-element-dimensions", f)
}();
