(function() {
  ...
  var Qa = function(a) {
    ...
    Va = function(a) {
      if (!(a instanceof H))
        if (a = "object" == typeof a && a.V ? a.L() : String(a), Ta.test(a)) a = new H(a, Pa);
        else {
          a = String(a);
          a = a.replace(/(%0A|%0D)/g, "");
          var b = a.match(Sa);
    ...
    pc = function(a) {
      if ("number" !== typeof a && a && !a.Y) {
        ...
        if (b && b[Yb]) cc(b.o, a);
          ...
          fc--;
          (c = kc(b)) ? (cc(c, a), 0 == c.ma && (c.src = null, b[dc] = null)) : ac(a)
        }
      }
    },
    mc = function(a) {
  ...
  var Jd = null,
    Kd = function() {
      ...
      if (a.body) a.body.appendChild(b);
        ...
        d = d && e ? "sanitizer-" + (Math.floor(2147483648 * Math.random()).toString(36) + Math.abs(Math.floor(2147483648 * Math.random()) ^ Date.now()).toString(36)) : b.Z;
        b.ca = d;
        if (od) {
          d = c;
          if (od) {
