...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("easing.CustomEase", ["easing.Ease"], function(a) {
      ...
      return m.constructor = l, m.setData = function(a, c) {
        ...
        for (d = u.length, l = 0; d > l; l++) o = u[l], p = u[l - 1] || o, o.x > p.x || p.y !== o.y && p.x === o.x || o === p ? (p.cx = o.x - p.x, p.cy = o.y - p.y, p.n = o, p.nx = o.x, this.fast && l > 1 && Math.abs(p.cy / p.cx - u[l - 2].cy / u[l - 2].cx) > 2 && (this.fast = !1), p.cx < t && (p.cx ? t = p.cx : p.cx = .001)) : (u.splice(l--, 1), d--);
