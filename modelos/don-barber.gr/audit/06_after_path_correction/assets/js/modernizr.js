! function(e, n, t) {
  ...
  function i(e) {
    ...
    Modernizr._config.enableClasses && (n += " " + t + e.join(" " + t), _ ? b.className.baseVal = n : b.className = n)
  }
  ...
  function p(e, t, r, o) {
    var i, a, l, f, u = "modernizr",
      ...
      p = c();
    if (parseInt(r, 10))
      for (; r--;) l = s("div"), l.id = o ? o[r] : u + (r + 1), d.appendChild(l);
  ...
  function v(e, n, o, i) {
    ...
    for (var d, c, p, v, h, g = ["modernizr", "tspan", "samp"]; !E.style && g.length;) d = !0, E.modElem = s(g.shift()), E.style = E.modElem.style;
    for (p = e.length, c = 0; p > c; c++)
      if (v = e[c], h = E.style[v], l(v, "-") && (v = a(v)), E.style[v] !== t) {
  ...
  function h(e, n, t, o, i) {
    ...
    return r(n, "string") || r(n, "undefined") ? v(a, n, o, i) : (a = (e + " " + k.join(s + " ") + s).split(" "), u(a, n, t))
  }
  ...
  var w = "Moz O ms Webkit",
    S = x._config.usePrefixes ? w.split(" ") : [];
  x._cssomPrefixes = S;
  var T = function(n) {
  ...
  x.atRule = T;
  var k = x._config.usePrefixes ? w.toLowerCase().split(" ") : [];
  x._domPrefixes = k;
  var z = {
    elem: s("modernizr")
  };
  ...
  var j = x.prefixed = function(e, n, t) {
    return 0 === e.indexOf("@") ? T(e) : (-1 != e.indexOf("-") && (e = a(e)), n ? h(e, n, t) : h(e, "pfx"))
  };
  Modernizr.addTest("backgroundblendmode", j("backgroundBlendMode", "text")), Modernizr.addTest("objectfit", !!j("objectFit"), {
    aliases: ["object-fit"]
  }), x.testAllProps = g, Modernizr.addTest("backgroundcliptext", function() {
    return g("backgroundClip", "text")
  }), Modernizr.addTest("bgsizecover", g("backgroundSize", "cover")), o(), i(y), delete x.addTest, delete x.addAsyncTest;
